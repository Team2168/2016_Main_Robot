...
public class Drivetrain extends Subsystem {
     ...
     * This objective is the augment the joystick value going to the motor controllers
    ...
    public double getLeftSpeed(){
    	...
    	if(Math.abs(Robot.oi.driverJoystick.getRightTriggerAxisRaw() - Robot.oi.driverJoystick.getLeftTriggerAxisRaw()) > 0.0)
    ...
    public double getRightSpeed(){
    	...
    	// if the trigger (brake) is pressed, use falcon claw method
    	if(Math.abs(Robot.oi.driverJoystick.getLeftTriggerAxisRaw() - Robot.oi.driverJoystick.getRightTriggerAxisRaw()) > 0.0)
