...
public class DriveXDistanceWithJoystick extends Command{
	 ...
	 */
	public DriveXDistanceWithJoystick(double distance) {
	...
	public DriveXDistanceWithJoystick(double distance, double speed) {
		this(distance);
		this.speed = speed;
	}
	...
	public DriveXDistanceWithJoystick(double distance, double speed, double error) {
		this(distance, speed);
		this.error = error;
	}
