...
/**
 * Drives Robot under the PC defense from the fourth position
 */
public class DriveUnderPCAndFireCenterFourth extends CommandGroup {
    
    public  DriveUnderPCAndFireCenterFourth() {
    	addSequential(new DriveUnderPCAuto());
    	addSequential(new RotateXDistancePIDZZZ(180, 0.8, 0.25, 1));
    	
    	//THE REST IS THE SAME AS THE VANILLA CenterFecond AUTO
