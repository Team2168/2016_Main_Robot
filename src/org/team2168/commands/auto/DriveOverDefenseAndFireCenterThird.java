 ...
 */
public class DriveOverDefenseAndFireCenterThird extends CommandGroup {
    
    public  DriveOverDefenseAndFireCenterThird() {
    	...
    	addSequential(new RotateXDistancePIDZZZ(13, 0.5, 0.25, 1));
    	addParallel(new DriveShooterPIDSpeed(6500));
    	
    	addSequential(new Sleep(), 0.7); // camera lag
    	addSequential(new RotateXDistancePIDZZZCameraWithGyro(0, 0.4, 0.23, 0.5));
